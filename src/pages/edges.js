  ...
  computed: {
    edges: function () {
      ...
      },
      {
        from: 'adhbstroke',
        to: 'pastapos',
        label: p(this.params.pPASTAPos.val) +
            ' +ve\nn = ' +
      ...
      },
      {
        from: 'adhbstroke',
        to: 'pastaneg',
        label: p(1.0 - this.params.pPASTAPos.val) +
            ' -ve\nn = ' +
      ...
      },
      {
        from: 'psinegadhb',
        to: 'hasu',
        label: p(this.params.pPSIIVTNegHASU.val) +
            '\nn = ' +
      ...
      },
      {
        from: 'psinegadhb',
        to: 'asu',
        label: p(1.0 - this.params.pPSIIVTNegHASU.val) +
            '\nn = ' +
            n(
